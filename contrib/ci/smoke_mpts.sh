...
EXPECT_TOT=1 EXPECT_CAT=1 EXPECT_PAT_NIT_PID=16 EXPECT_PNRS="101,102" EXPECT_PMT_PNRS="101,102" EXPECT_PMT_PIDS="101=33,102=35" EXPECT_PMT_ES_PIDS="101=32;102=34" EXPECT_NIT_SERVICE_LIST="101=1,102=1" EXPECT_NIT_TS_LIST="1:1,2:1,3:1" EXPECT_SDT_SERVICE_NAMES="101=MPTS Test 1,102=MPTS Test 2" EXPECT_SDT_PROVIDER_NAMES="101=Astral,102=Astral" EXPECT_SERVICE_COUNT=2 EXPECT_PMT_STREAMS="101=1,102=1" EXPECT_PMT_VIDEO="101=1,102=1" EXPECT_PMT_AUDIO="101=0,102=0" EXPECT_PMT_DATA="101=0,102=0" EXPECT_PMT_PCR="101=32,102=34" EXPECT_PMT_PCR_IN_ES="101=1,102=1" EXPECT_NO_CC_ERRORS=1 EXPECT_NO_PES_ERRORS=1 EXPECT_NO_SCRAMBLED=1 EXPECT_SERVICES="MPTS Test 1,MPTS Test 2" EXPECT_PROVIDERS="Astral" EXPECT_NETWORK_ID=1 EXPECT_NETWORK_NAME="Astral" EXPECT_TSID=1 EXPECT_DELIVERY="cable" EXPECT_FREQUENCY_KHZ=650000 EXPECT_SYMBOLRATE_KSPS=6875 EXPECT_MODULATION="256qam" EXPECT_FEC="auto" EXPECT_LCN="101=101,102=102" EXPECT_FREE_CA="101=0,102=0" EXPECT_SERVICE_TYPE="101=1,102=1" EXPECT_BITRATE_KBIT=50000 EXPECT_BITRATE_TOL_PCT=15 tools/verify_mpts.sh "udp://127.0.0.1:12346" 5
