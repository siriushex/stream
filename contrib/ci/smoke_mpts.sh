...
EXPECT_TOT=1 EXPECT_PNRS="101,102" EXPECT_SERVICES="MPTS Test 1,MPTS Test 2" EXPECT_PROVIDERS="Astral" EXPECT_NETWORK_ID=1 EXPECT_TSID=1 tools/verify_mpts.sh "udp://127.0.0.1:12346" 5
