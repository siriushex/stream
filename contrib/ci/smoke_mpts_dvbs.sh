...
PORT="${PORT:-9056}"
DATA_DIR="${DATA_DIR:-./data_ci_mpts_dvbs}"
WEB_DIR="${WEB_DIR:-./web}"
LOG_FILE="${LOG_FILE:-./ci_server_mpts_dvbs.log}"
CONFIG_FILE="${CONFIG_FILE:-./fixtures/mpts_dvbs.json}"
