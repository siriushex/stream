...
cfg3.input = {
    ...
    "http://127.0.0.1:9060/dvr/internal/play/" .. stream_id .. "?internal=1",
...
for _, value in ipairs(cfg4.input or {}) do
    ...
    assert_true(tostring(value) ~= "http://127.0.0.1:9060/dvr/internal/play/" .. stream_id .. "?internal=1",
        "legacy /dvr/internal/play input with internal=1 must be removed")
end
