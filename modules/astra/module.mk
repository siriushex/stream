...
SOURCES="$SOURCES sha1.c base64.c md5.c rc4.c strhex.c"
SOURCES="$SOURCES astra.c log.c timer.c utils.c json.c iso8859.c"
SOURCES="$SOURCES observability_worker.c"
MODULES="astra log timer utils json base64 sha1 md5 rc4 str2hex iso8859 observability_worker"
