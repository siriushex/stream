...
Usage: $0 [OPTIONS]
    ...
    --without-transcode         - build without transcode support (no ffmpeg features)
...
CFLAGS="$CFLAGS -DSTREAM_WITH_TRANSCODE=$ARG_WITH_TRANSCODE"
...
#define STREAM_WITH_TRANSCODE $ARG_WITH_TRANSCODE
