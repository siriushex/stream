...
int event_create(event_t event)
{
    ...
    if(event)
    {
        if(mutex_init(&event->mutex_val, 1))
        {
            event->magic = 0x7EA3C6F1;
            event->have_event = 0;
            result = 0;
        }
        else
...
int event_destroy(event_t event)
{
    ...
    if(event)
    {
        ...
        {
            logout("%s:%d: Invalid magic value 0x%X\n", __FUNCTION__, 48, (unsigned int)event->magic);
        }
    }
    else
    {
        logout("%s:%d: Invalid arguments %p\n", __FUNCTION__, 53, event);
    }
...
int event_reset(event_t event)
{
    ...
    if(event)
    {
        ...
        {
            logout("%s:%d: Invalid magic value 0x%X\n", __FUNCTION__, 80, (unsigned int)event->magic);
        }
    }
    else
    {
        logout("%s:%d: Invalid arguments %p\n", __FUNCTION__, 85, event);
    }
...
int event_send(event_t event)
{
    ...
    if(event)
    {
        ...
        {
            logout("%s:%d: Invalid magic value 0x%X\n", __FUNCTION__, 113, (unsigned int)event->magic);
        }
    }
    else
    {
        logout("%s:%d: Invalid arguments %p\n", __FUNCTION__, 118, event);
    }
...
int event_wait(event_t event, int msec)
{
    ...
    if(event)
    {
        ...
        {
            logout("%s:%d: Invalid magic value 0x%X\n", __FUNCTION__, 163, (unsigned int)event->magic);
        }
    }
    else
    {
        logout("%s:%d: Invalid arguments %p\n", __FUNCTION__, 168, event);
    }
