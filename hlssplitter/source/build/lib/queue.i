...
int int_create_queue(ComQueue_t *queue, unsigned int object_size, unsigned int max_messages, void *queue_mem)
{
    ...
    if(queue && object_size && max_messages && queue_mem)
    {
        ...
        if(mutex_init(&queue->queueMutex, 1))
        {
            queue->magic = 0x432A8B1D;
    ...
    {
        logout("%s %d: Invalid arguments %p 0x%X 0x%X %p\n", __FUNCTION__, 32, queue, (unsigned int)object_size, (unsigned int)max_messages, queue_mem);
    }
...
int create_queue(ComQueue_t *queue, unsigned int object_size, unsigned int max_messages)
{
    ...
    if(queue && object_size && max_messages)
    {
        ...
        {
            logout("%s %d: Failed alloc %d bytes of memory\n", __FUNCTION__, 60, (unsigned int) object_size * max_messages);
        }
    }
    else
    {
        logout("%s %d: Invalid arguments %p 0x%X 0x%X\n", __FUNCTION__, 65, queue, (unsigned int)object_size, (unsigned int)max_messages);
    }
...
int create_queue_noalloc(ComQueue_t *queue, unsigned int object_size, unsigned int max_messages, void *queue_addr)
{
    ...
    {
        logout("%s %d: Invalid arguments %p 0x%X 0x%X %p\n", __FUNCTION__, 81, queue, (unsigned int)object_size, (unsigned int)max_messages, queue_addr);
    }
...
_Bool queue_getMessage(ComQueue_t *queue, void *mes, int miliseconds, _Bool need_eject)
{
    ...
    if(queue)
    {
        ...
        {
            logout("%s %d: Invalid magic value 0x%X\n", __FUNCTION__, 191, (unsigned int)queue->magic);
        }
    }
    else
    {
        logout("%s %d: Invalid argument %p\n", __FUNCTION__, 196, queue);
    }
...
_Bool queue_setMessage(ComQueue_t *queue, void *mes)
{
    ...
    if(queue)
    {
        ...
        {
            logout("%s %d: Invalid magic value 0x%X\n", __FUNCTION__, 236, (unsigned int)queue->magic);
        }
    }
    else
    {
        logout("%s %d: Invalid argument %p\n", __FUNCTION__, 241, queue);
    }
...
unsigned int queue_size(ComQueue_t *queue)
{
    ...
    if(queue)
    {
        ...
        {
            logout("%s %d: Invalid magic value 0x%X\n", __FUNCTION__, 259, (unsigned int)queue->magic);
        }
    }
    else
    {
        logout("%s %d: Invalid argument %p\n", __FUNCTION__, 264, queue);
    }
